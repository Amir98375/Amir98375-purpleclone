...
function  upi_show(){
 ...
 //document.getElementById("head-sum").innerHTML=`Order Summary(${cartArr.length}items)`;

 console.log(cartArr);
 
 appendcartItems(cartArr)
 ...
 function  appendcartItems(data){
   ...
   function deleteItem(index){
    ...
    appendcartItems(cartArr)
    document.querySelector("#head-sum").textContent=`Order Summary(${cartArr.length}items)`;
   
}
 

var tp;
tp=cartArr.reduce(function(ac,cv){
